...
const SearchParams = () => {
    ...
    return (
        <div className=" grid-rows-auto   grid grid-cols-1 lg:grid-cols-12">
            <form
                className="m-2 grid content-start justify-items-center rounded-lg bg-bright-sky bg-opacity-80 py-4 md:col-span-2 lg:col-span-4 xl:col-span-3 2xl:col-span-3 2xl:col-start-2"
                onSubmit={(e) => {
                    e.preventDefault();
