...
const Results = ({ pets }) => {
    ...
    return (
        ...
        <section className=" ml-2 my-2 grid grid-cols-1 justify-items-stretch gap-4 rounded-lg bg-grey-snow px-4 py-4 sm:grid-cols-2 lg:grid-rows-2 lg:col-span-8 lg:grid-cols-3 xl:col-span-9 xl:col-start-4 xl:grid-cols-4">
            {!pets.length ? (
                <h1>No Pets Found</h1>
            ) : (
